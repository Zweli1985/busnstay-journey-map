...
import { 
  ...
  Star, Zap, Clock, Utensils, TrendingUp
} from 'lucide-react';
...
const LandingPageEnhanced = ({ onRouteSelect }: LandingPageEnhancedProps) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-50">
      {/* Navigation Header */}
      <header className="sticky top-0 z-50 backdrop-blur-sm bg-white/90 border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          >
            <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-slate-800 to-slate-700 flex items-center justify-center shadow-lg">
              <Utensils className="w-5 h-5 text-white" />
            </div>
            <div>
              <h1 className="font-bold text-lg text-slate-900">BusNStay</h1>
              <p className="text-xs text-slate-500">Premium Food on Route</p>
            </div>
          </motion.div>
          ...
          <div className="flex items-center gap-2">
            {user ? (
              <>
                <Button variant="ghost" size="sm" className="text-slate-700 hover:bg-slate-100" onClick={() => navigate('/dashboard')}>
                  Dashboard
                </Button>
                <Button variant="ghost" size="sm" className="text-slate-700 hover:bg-slate-100">Sign Out</Button>
              </>
            ) : (
              <>
                <Button variant="ghost" size="sm" className="text-slate-700 hover:bg-slate-100" onClick={() => navigate('/auth')}>
                  Sign In
                </Button>
                <Button size="sm" className="bg-teal-600 hover:bg-teal-700 text-white" onClick={() => navigate('/auth')}>
                  Get Started
                </Button>
              </>
            )}
      ...
      {/* Hero Section */}
      <section className="relative px-4 py-24 md:py-40 max-w-7xl mx-auto">
      ...
      {/* Search Section */}
      <section className="px-4 py-20 bg-gradient-to-b from-slate-900 to-slate-950 text-white">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-white text-slate-900 hover:bg-slate-100 font-bold shadow-lg">
                <Utensils className="w-5 h-5 mr-2" />
                Order Now
              </Button>
              <Button size="lg" className="bg-teal-600 hover:bg-teal-700 text-white font-bold shadow-lg border-2 border-teal-400">
