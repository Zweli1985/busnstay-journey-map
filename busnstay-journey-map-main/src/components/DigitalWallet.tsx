...
const DigitalWallet = ({
  ...
  const totalReceivedMonth = transactions
    .filter(t => (t.type === 'credit' || t.type === 'refund') && new Date(t.timestamp).getMonth() === new Date().getMonth())
    .reduce((sum, t) => sum + t.amount, 0);
      ...
      >
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-12">
            <div>
              <p className="text-blue-100 text-sm uppercase tracking-wider mb-2">Total Balance</p>
